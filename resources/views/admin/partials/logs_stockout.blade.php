    ...
    <table class="table table-hover align-middle custom-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="status-badge status-primary">-{{ $log->quantity }}</span></td>
                <td>
                ...
                <td class="text-end pe-4">
                    <button type="button" class="btn btn-white btn-sm shadow-sm px-3" data-bs-toggle="modal" data-bs-target="#stockOutDetailsModal{{ $log->id }}">
            ...
            <div class="modal-header border-0 pb-0">
                <div class="d-flex align-items-center">
                    <div class="bg-primary bg-opacity-10 p-2 rounded-3 me-3">
                        <i class="fa-solid fa-arrow-up text-primary fs-4"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold">Stock Out Details</h5>
                ...
                <div class="bg-light rounded-4 p-3 mb-4">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <div><span class="status-badge status-primary">-{{ $log->quantity }}</span></div>
                        </div>
                        <div class="col-6">
