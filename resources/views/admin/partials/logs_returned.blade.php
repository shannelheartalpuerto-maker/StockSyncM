    ...
    <table class="table table-hover align-middle custom-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="status-badge status-info">+{{ $log->quantity }}</span></td>
                <td>
                ...
                <td class="text-end pe-4">
                    <button type="button" class="btn btn-white btn-sm shadow-sm px-3" data-bs-toggle="modal" data-bs-target="#returnDetailsModal{{ $log->id }}">
            ...
            <tr>
                <td colspan="5" class="text-center py-5">
                    ...
                    <p class="text-muted">No returned records found.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header border-0 pb-0">
                <div class="d-flex align-items-center">
                    <div class="bg-info bg-opacity-10 p-2 rounded-3 me-3">
                        <i class="fa-solid fa-rotate-left text-info fs-4"></i>
                    </div>
                    <div>
            ...
            <div class="modal-body p-4">
                <div class="alert alert-indigo bg-opacity-10 border-0 mb-4 py-2 px-3">
                    <div class="d-flex align-items-center">
                        <i class="fa-solid fa-receipt me-2 text-indigo small"></i>
                        <span class="fw-bold text-indigo small">{{ $transactionRef }}</span>
                    </div>
                </div>
                ...
                <div class="bg-light rounded-4 p-3 mb-4">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <div><span class="status-badge status-info">+{{ $log->quantity }}</span></div>
                        </div>
                        <div class="col-6">
