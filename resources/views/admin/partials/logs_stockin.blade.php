    ...
    <table class="table table-hover align-middle custom-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="status-badge status-success">+{{ $log->quantity }}</span></td>
                <td>
                ...
                <td class="text-end pe-4">
                    <button type="button" class="btn btn-white btn-sm shadow-sm px-3" data-bs-toggle="modal" data-bs-target="#stockInDetailsModal{{ $log->id }}">
...
<div class="mt-4">
    {{ $stockIns->appends(['out_page' => $stockOuts->currentPage(), 'returned_page' => $returnedStocks->currentPage(), 'damaged_page' => $damagedStocks->currentPage(), 'period' => $period])->links() }}
</div>
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header border-0 pb-0">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold">Stock In Details</h5>
                ...
                <div class="bg-light rounded-4 p-3 mb-4">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <div><span class="status-badge status-success">+{{ $log->quantity }}</span></div>
                        </div>
                        <div class="col-6">
