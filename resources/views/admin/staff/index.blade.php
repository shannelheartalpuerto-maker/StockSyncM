    ...
    <div class="inv-topbar mb-4">
        <div class="inv-topbar-inner">
            <div class="inv-title-wrap">
                <span class="inv-title-icon"><i class="fa-solid fa-user-group"></i></span>
                <h5 class="inv-title-text">Staff Management</h5>
            </div>
            <div class="inv-header-actions">
                <span class="inv-head-pill"><i class="fa-solid fa-users"></i>{{ method_exists($staff, 'total') ? number_format($staff->total()) : number_format($staff->count()) }} Staff</span>
                <span class="inv-head-pill"><i class="fa-solid fa-user-check"></i>Active Personnel</span>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="main-form-shell h-100">
                        ...
                        <h6 class="fw-bold mb-3 text-teal"><i class="fa-solid fa-user-plus me-2"></i>Add New Staff</h6>
                        <form method="POST" action="{{ route('admin.staff.store') }}" id="staffForm">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group search-input-group border">
                                    ...
                                    <input type="text" class="form-control border-0 bg-transparent @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Maria Clara">
                                </div>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group search-input-group border">
                                    ...
                                    <input type="email" class="form-control border-0 bg-transparent @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required placeholder="maria@example.com">
                                </div>
                                @error('email')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        @else
                        <h6 class="fw-bold mb-3 text-teal"><i class="fa-solid fa-user-shield me-2"></i>Account Creation Locked</h6>
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-5">
                                        <div class="py-3">
                                            ...
                                            <p class="text-muted">No staff accounts found.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endif
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const replaceModals = (html) => {
        ...
        document.querySelectorAll('.modal[data-managed-staff-modal="1"]').forEach((el) => el.remove());
        modalsMount.innerHTML = html;
        modalsMount.querySelectorAll('.modal').forEach((modalEl) => {
            modalEl.setAttribute('data-managed-staff-modal', '1');
